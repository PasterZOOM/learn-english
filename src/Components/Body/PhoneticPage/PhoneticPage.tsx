...
export type TransliterationType = {
    id: string,
...
export type TranscriptionsType = Array<TransliterationType>

export const PhoneticPage = () => {
    const transcriptions: TranscriptionsType = [
        {
            id: v1(),
            transcription: '[ i: ]',
            rus: 'и-и',
        ...
        <Container fixed>
            <Grid container textAlign={'center'} spacing={5}>
                <Grid item xs={6}>
                    ...
                    <Grid container>
                        {transcriptions.map((sign: TransliterationType) => {
                            return sign.vowel && (
